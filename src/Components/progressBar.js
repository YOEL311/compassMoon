...
import {Platform, TextInput, StyleSheet, Text, View, Animated, ImageBackground} from 'react-native';
    ...
    return (
      <View style={styles.container}>
        <ImageBackground
          ...
          <Animated.View
            style={[styles.inner, {backgroundColor: this.color, height: parseInt(this.state.pr) + "%"},]}
          />
        </ImageBackground>
      </View>
    )
